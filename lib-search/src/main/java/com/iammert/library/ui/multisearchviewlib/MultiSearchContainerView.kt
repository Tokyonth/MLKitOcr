...
class MultiSearchContainerView @JvmOverloads constructor(
    ...
    private val binding: ViewMultiSearchContainerBinding = ViewMultiSearchContainerBinding.inflate(
        LayoutInflater.from(context), this, true
    )

    private val sizeRemoveIcon =
        context.resources.getDimensionPixelSize(R.dimen.msv_size_remove_icon)
            ...
            when {
                ...
                widthWithoutCurrentSearch < viewWidth -> {
                    ...
                    val scrollEnterEndValue =
                        (binding.layoutItemContainer.measuredWidth - viewWidth).toInt()
                    ...
                    val scrollEnterEndValue =
                        (widthWithoutCurrentSearch - viewWidth + searchViewWidth.toInt()).toInt()
                    searchEnterScrollAnimation.setIntValues(
                        scrollEnterStartValue,
                        scrollEnterEndValue
                    )
    ...
    fun completeSearch() {
        ...
        selectedTab?.let {
            ...
            val endWidthValue =
                it.editTextSearch.measuredWidth + sizeRemoveIcon + defaultPadding
    ...
    private fun createNewSearchView(): ViewItemBinding {
        ...
        viewItem.root.layoutParams =
            LinearLayout.LayoutParams(searchViewWidth.toInt(), WRAP_CONTENT)
        ...
        viewItem.editTextSearch.addTextChangedListener(object : SimpleTextWatcher() {
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                ...
                s?.let {
                    multiSearchViewListener?.onTextChanged(
                        binding.layoutItemContainer.childCount - 1,
                        it
                    )
                }
